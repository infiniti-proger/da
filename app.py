...
def photo_src(n):
    if n in photos_b64:
        return f"data:image/jpeg;base64,{photos_b64[n]}"
    return ""
...
<section class="scene photo-scene" id="scene2">
    <div class="scene-inner"><div class="photo-wrapper">
        <img class="photo" src="__PHOTO_1__" alt="Наш момент">
...
<section class="scene photo-scene" id="scene3">
    <div class="scene-inner"><div class="photo-wrapper">
        <img class="photo" src="__PHOTO_2__" alt="Наш момент">
        <div class="photo-caption">
...
<section class="scene photo-scene" id="scene4">
    <div class="scene-inner"><div class="photo-wrapper">
        <img class="photo" src="__PHOTO_3__" alt="Наш момент">
        <div class="photo-caption">
...
<section class="scene photo-scene" id="scene5">
    <div class="scene-inner"><div class="photo-wrapper">
        <img class="photo" src="__PHOTO_4__" alt="Наш момент">
        <div class="photo-caption">
...
<section class="scene photo-scene" id="scene6">
    <div class="scene-inner"><div class="photo-wrapper">
        <img class="photo" src="__PHOTO_5__" alt="Наш момент">
        <div class="photo-caption">
...
<section class="scene photo-scene" id="scene7">
    <div class="scene-inner"><div class="photo-wrapper">
        <img class="photo" src="__PHOTO_6__" alt="Наш момент">
        <div class="photo-caption">
...
<section class="scene photo-scene" id="scene8">
    <div class="scene-inner"><div class="photo-wrapper">
        <img class="photo" src="__PHOTO_7__" alt="Наш момент">
        <div class="photo-caption">
...
<section class="scene photo-scene" id="scene9">
    <div class="scene-inner"><div class="photo-wrapper">
        <img class="photo" src="__PHOTO_8__" alt="Наш момент">
        <div class="photo-caption">
...
<section class="scene photo-scene" id="scene10">
    <div class="scene-inner"><div class="photo-wrapper">
        <img class="photo" src="__PHOTO_9__" alt="Наш момент">
        <div class="photo-caption">
...
<section class="scene photo-scene" id="scene11">
    <div class="scene-inner"><div class="photo-wrapper">
        <img class="photo" src="__PHOTO_10__" alt="Наш момент">
        <div class="photo-caption">
...
<audio id="music" loop preload="auto">
    <source src="__MUSIC__" type="audio/mpeg">
</audio>
...
function playMusic() {
    ...
    music.volume = 0.45;
    const p = music.play();
    if (p !== undefined) p.catch(() => { musicStarted = false; });
    musicButton.innerHTML = "♫";
}
function toggleMusic(event) {
    if (event) event.stopPropagation();
    if (music.paused) {
        music.play().then(() => { musicButton.innerHTML = "♫"; })
            .catch(() => { musicButton.innerHTML = "♪"; });
    } else {
        music.pause();
        musicButton.innerHTML = "♪";
    }
...
function checkAnswer(event) {
    ...
    const correct = normalizeAnswer(quests[questIndex].answer);
    if (!answer) { message.innerText = "Напиши ответ ❤️"; return; }
    if (answer === correct) {
        createHeartExplosion();
        questIndex++;
        ...
        message.innerText = "Правильно ❤️";
        setTimeout(() => {
            showQuest();
            document.getElementById("answerInput").focus();
        }, 500);
    } else {
        message.innerText = "Не совсем... попробуй ещё ❤️";
        input.value = "";
        input.focus();
    }
}
...
document.addEventListener("keydown", function(event) {
    ...
    if (event.key === "Enter") {
        if (currentScene === 15) checkAnswer(event);
        return;
    }
    if (currentScene === 12 || currentScene === 13) return;
    if (event.key === "ArrowRight" || event.key === "ArrowDown") {
        if (currentScene >= 1 && currentScene < 14) nextScene(event);
    }
...
document.addEventListener("click", function(event) {
    ...
    if (event.target.closest("button") || event.target.closest("input") ||
        event.target.closest(".music") || event.target.closest(".gift") ||
        event.target.closest(".answer-box")) return;
    nextScene(event);
});
</script>
...
# Подставляем фото и музыку
for i in range(1, 11):
    src = photo_src(i)
    html = html.replace(f"__PHOTO_{i}__", src)

if music_b64:
    html = html.replace("__MUSIC__", f"data:audio/mpeg;base64,{music_b64}")
else:
